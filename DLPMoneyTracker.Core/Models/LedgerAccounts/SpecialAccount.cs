...
namespace DLPMoneyTracker.Core.Models.LedgerAccounts
{
    ...
    {
        public static SpecialAccount InitialBalance { get { return new SpecialAccount() { Id = new Guid("11111111-1111-1111-1111-111111111111"), Description = "*STARTING BALANCE*" }; } }
        public static SpecialAccount UnlistedAdjustment { get { return new SpecialAccount() { Id = new Guid("99999999-8888-7777-6666-555555555555"), Description = "*CORRECTION*" }; } }
