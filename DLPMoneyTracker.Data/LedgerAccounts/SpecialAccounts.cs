...
namespace DLPMoneyTracker.Data.LedgerAccounts
{
    public class SpecialAccount : IJournalAccount
    {
        ...
        public static SpecialAccount DebtInterest { get { return new SpecialAccount() { Id = new Guid("DDDDDDDD-EEEE-BBBB-TTTTTTTTTTTT"), Description = "*INTEREST ACCRUES*" }; } }
        public static SpecialAccount DebtReduction { get { return new SpecialAccount() { Id = new Guid("REWARDSS-0000-0000-REFUNDS11111"), Description = "*DEBT REDUCTION*" }; } }
