...
namespace DLPMoneyTracker.Data
{
    ...
    public class AppConfigSettings
    {
        ...
        public const string DATA_FOLDER_PATH = @"D:\Program Files\DLP Money Tracker\Data\";

        // TODO: Modify program to store the Tracker Config Path in a config file
        public const string CONFIG_FOLDER_PATH = @"D:\Program Files\DLP Money Tracker\Config\";
