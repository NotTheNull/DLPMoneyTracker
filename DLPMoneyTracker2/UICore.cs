...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    {
        services.AddLogging();
        services.AddTransient<ILogger, DLPLogger>();
    }
    ...
    private static void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<IGetIncomeStatementDataUseCase, GetIncomeStatementDataUseCase>();
        ...
        // Reports
        services.AddTransient<IncomeStatementVM>();
        services.AddTransient<IncomeStatementUI>();
