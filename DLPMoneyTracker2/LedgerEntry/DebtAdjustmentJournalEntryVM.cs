...
{
    public class DebtAdjustmentJournalEntryVM(
        ...
        BaseRecordJournalEntryVM(
            ...
            [LedgerType.LiabilityLoan, LedgerType.LiabilityCard],
            [LedgerType.NotSet],
            TransactionType.DebtAdjustment)
    {
        ...
        public override string DebitHeader => "Debt Account";
        public override string CreditHeader => "Action";
        ...
        {
            if (this.SelectedDebitAccount is null || this.SelectedCreditAccount is null) return;
